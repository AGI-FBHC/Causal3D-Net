...
from src.models.Hybrid_Transformer.Hybrid import ResHybrid
...
def get_model(num_classes=1000, edge_size=224, model_idx=None, drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0.0,
    ...
    if model_idx[0:5] == 'ViT_h':
        ...
        from src.models.Hybrid_Transformer.counterpart_models import conformer
        ...
        from src.models.Hybrid_Transformer.counterpart_models import crossformer
    ...
    # try:
    #     img = torch.randn(1, 50, edge_size, edge_size)
...
if __name__ == '__main__':
    ...
    # 创建输入数据并放入 GPU
    x = torch.randn(1, 50, patch_size, patch_size).to(device)
