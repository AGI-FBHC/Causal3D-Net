...
def mask_volume_box(file_path):
    ...
    # 将所有信息整理成一个列表返回
    result = list(shape) + list(box_shape) + [mask_volume] + min_corner_coords.tolist() + max_corner_coords.tolist()
    return result
...
def through_files():
    ...
    # logging.basicConfig(
    #     filename="/home/huangdn/Causal3D-Net/src/logging_record/mask_size_record.log",
    #     level=logging.INFO,
